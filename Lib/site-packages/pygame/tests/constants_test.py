...
def create_overlap_set(constant_names):
    """Helper function to find overlapping header values/names.
...
class KConstantsTests(unittest.TestCase):
    ...
    # Create a sequence of all the K_* header names.
    ...
    def test_k__existence(self):
        ...
        for name in self.K_NAMES:
            self.assertTrue(
                hasattr(pygame.constants, name), "missing header {}".format(name)
            )
    ...
    def test_k__value_overlap(self):
        """Ensures no unexpected K header values overlap."""
...
class KscanConstantsTests(unittest.TestCase):
    ...
    # Create a sequence of all the KSCAN_* header names.
    KSCAN_NAMES = tuple(
    ...
    def test_kscan__value_overlap(self):
        """Ensures no unexpected KSCAN header values overlap."""
        EXPECTED_OVERLAPS = set(
            [
...
class KmodConstantsTests(unittest.TestCase):
    ...
    def test_kmod__value_overlap(self):
        """Ensures no unexpected KMOD header values overlap."""
